...
const HeroSection = () => {
  return <section className="min-h-screen flex flex-col justify-center items-center px-4 sm:px-6 py-16 sm:py-20 bg-gradient-to-br from-white via-gray-50 to-white relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-16 items-center">
          ...
          <div className="order-1 lg:order-1 text-center lg:text-left animate-scale-in">
            <h1 className="text-4xl sm:text-6xl md:text-8xl lg:text-9xl font-sf font-extralight text-gray-900 leading-none tracking-tight">
          ...
          <div className="order-2 lg:order-2 animate-fade-in">
            ...
            <p className="text-lg sm:text-xl md:text-2xl text-gray-600 mb-6 sm:mb-8 leading-relaxed font-sf font-light">
            ...
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4">
              <a href="https://wa.me/5513991808329?text=Olá%2C+quero+uma+landing+page+profissional" target="_blank" rel="noopener noreferrer" className="inline-flex items-center justify-center bg-blue-600 text-white px-6 sm:px-8 py-3 sm:py-4 rounded-2xl text-base sm:text-lg font-sf font-medium hover:bg-blue-700 transition-all duration-300 transform hover:scale-105 hover:shadow-xl group touch-manipulation" aria-label="Solicitar orçamento para landing page via WhatsApp">
                <span>Quero minha landing page</span>
                <ArrowDown className="w-4 h-4 sm:w-5 sm:h-5 ml-2 transform rotate-[-45deg] group-hover:translate-x-1 transition-transform" />
              </a>
            </div>
          </div>
        </div>
