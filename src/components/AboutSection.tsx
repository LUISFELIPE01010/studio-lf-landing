...
const AboutSection = () => {
  return <section className="py-16 sm:py-24 lg:py-32 px-4 sm:px-6 bg-gradient-to-b from-gray-50 to-white relative">
          ...
          <div className="animate-scale-in relative">
            ...
            <div className="relative max-w-md mx-auto">
              <img 
                ...
                alt="Luis Felipe - Web Designer especialista em landing pages profissionais, jovem de 21 anos sorrindo" 
