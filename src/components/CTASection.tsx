      ...
      <div className="max-w-6xl mx-auto text-center animate-fade-in relative z-10">
        ...
        <div className="flex flex-col sm:flex-row gap-6 justify-center items-center mb-16">
          <a
            ...
            className="group bg-blue-600 text-white px-10 py-5 rounded-2xl text-xl font-sf font-semibold hover:bg-blue-700 transition-all duration-300 transform hover:scale-105 hover:shadow-2xl flex items-center gap-3"
          >
